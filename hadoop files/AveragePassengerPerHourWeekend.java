...
public class AveragePassengerPerHourWeekend {
    private static final Log LOG = LogFactory.getLog(AveragePassengerPerHourWeekend.class);
    ...
    public static class TokenMapper extends Mapper<Object, Text, Text, DoubleWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (!Character.isDigit(tokens[3].charAt(0))) // to skip the header
                return;
            one.set(Integer.valueOf(tokens[3]));
            ...
            try {
                ...
                {
					Text weekend = new Text("Weekend"+date.getHours())
					word.set(weekend);
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(AveragePassengerPerHourWeekend.class);
