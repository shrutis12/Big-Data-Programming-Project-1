...
public class AverageTripDistancePerHourWeekend {
    private static final Log LOG = LogFactory.getLog(AverageTripDistancePerHourWeekend.class);
    ...
    public static class TokenMapper extends Mapper<Object, Text, Text, DoubleWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (!Character.isDigit(tokens[4].charAt(0))) // to skip the header
                return;
            one.set(Double.valueOf(tokens[4]));//column 4 contains trip distance in miles.
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(AverageTripDistancePerHourWeekend.class);
