...
public class AveragePassengerPerHourWeekday {
    private static final Log LOG = LogFactory.getLog(AveragePassengerPerHourWeekday.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(AveragePassengerPerHourWeekday.class);
